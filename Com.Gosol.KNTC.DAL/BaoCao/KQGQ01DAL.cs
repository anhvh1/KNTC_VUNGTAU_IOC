...
namespace Com.Gosol.KNTC.DAL.BaoCao
{
    public class KQGQ01DAL
    {
        ...
        public List<TableData> KQGQ01(List<int> listCapChonBaoCao, string ContentRootPath, int RoleID, int CapID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, int HuyenDangNhapID, DateTime startDate, DateTime endDate)
        {
            ...
            foreach (DataRow dro in dt.Rows)
            {
                ...
                double col5 = col20 + col21 + col22 + col23 + col24;
                ...
                RowItem RowItem6 = new RowItem(6, Utils.AddCommas(col5), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
                ...
                RowItem RowItem8 = new RowItem(8, Utils.AddCommasDouble_Tien(dro["Col7Data"].ToString()), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
                ...
                RowItem RowItem10 = new RowItem(10, Utils.AddCommasDouble_Tien(dro["Col9Data"].ToString()), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
        ...
        public string KQGQ01_Excel(string rootPath, string pathFile, List<TableData> data, DateTime tuNgay, DateTime denNgay)
        {
            //var camera = new Camera;
            // path to your excel file
            string path = rootPath + @"\Templates\BaoCao\KQGQ01.xlsx";
        ...
        public static void CalculateBaoCaoCapTinh(string ContentRootPath, int RoleID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, ref List<BaoCao2cInfo> resultList, DateTime startDate, DateTime endDate, List<CapInfo> capList, bool flag, int tinhID, ref DataTable dt)
        {
            ...
            if (capList.Count > 0)
            {
                ...
                if (cqList.Count > 0)
                {
                    ...
                    try
                    {
                        using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, "v2_BaoCaoKQGQ01", parm))
                        {
                            dt.Load(dr);
                        }
                    }
        ...
        public static void CalculateBaoCaoCapHuyen(string ContentRootPath, int RoleID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, int HuyenDangNhapID, ref List<BaoCao2cInfo> resultList, DateTime startDate, DateTime endDate, int tinhID, ref DataTable dt)
        {
            ...
            foreach (DataRow dro in dt.Rows)
            {
                    ...
                    || Utils.ConvertToInt32(dro["CapID"], 0) == (int)CapQuanLy.ToanHuyen || Utils.ConvertToInt32(dro["CapID"], 0) == (int)CapQuanLy.CapPhong)
                {
                    ...
                    dr1["slCol15"] = Utils.ConvertToInt32(dr1["slCol15"], 0) +
                           Utils.ConvertToInt32(dro["slCol15"], 0);

                    dr1["slCol17"] = Utils.ConvertToInt32(dr1["slCol17"], 0) +
                           Utils.ConvertToInt32(dro["slCol17"], 0);

                    dr1["slCol20"] = Utils.ConvertToInt32(dr1["slCol20"], 0) +
                           Utils.ConvertToInt32(dro["slCol20"], 0);

                    dr1["slCol25"] = Utils.ConvertToInt32(dr1["slCol25"], 0) +
                           Utils.ConvertToInt32(dro["slCol25"], 0);

                    dr1["slCol30"] = Utils.ConvertToInt32(dr1["slCol30"], 0) +
                           Utils.ConvertToInt32(dro["slCol30"], 0);

                    dr1["slCol34"] = Utils.ConvertToInt32(dr1["slCol34"], 0) +
                           Utils.ConvertToInt32(dro["slCol34"], 0);
        ...
        public List<TKDonThuInfo> KQGQ01_GetDSChiTietDonThu(string ContentRootPath, DateTime startDate, DateTime endDate, int start, int pagesize, int? Index, int? xemTaiLieuMat, int? canBoID, int coQuanID, int? capID)
        {
        ...
        public List<TKDonThuInfo> GetDSChiTietDonThu(DateTime startDate, DateTime endDate, List<CoQuanInfo> ListCoQuan, int start, int pagesize, int? Index, int? xemTaiLieuMat, int? canBoID, int? capID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, "v2_BaoCaoKQGQ01_GetDSChiTietDonThu", parm))
                {
                    while (dr.Read())
                    {
    ...
    public class BaoCao2cInfo
    {
        ...
        public decimal Col16Data { get; set; }
        public int Col17Data { get; set; }
        public decimal Col18Data { get; set; }
        ...
        public decimal Col31Data { get; set; }
        public int Col32Data { get; set; }
        public decimal Col33Data { get; set; }
        public int Col34Data { get; set; }
        public decimal Col35Data { get; set; }
        public int Col36Data { get; set; }
        public decimal Col37Data { get; set; }
