...
{
    public class XLD02DAL
    {
        public List<TableData> XLD02(List<int> listCapChonBaoCao, string ContentRootPath, int RoleID, int CapID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, int HuyenDangNhapID, DateTime startDate, DateTime endDate)
        {
            ...
            foreach (DataRow dro in dt.Rows)
            {
                ...
                double col8 = Utils.ConvertToDouble(dro["Col8Data"], 0);
                ...
                double col27 = Utils.ConvertToDouble(dro["Col27Data"], 0);
                double col28 = Utils.ConvertToDouble(dro["Col28Data"], 0);
                double col29 = Utils.ConvertToDouble(dro["Col29Data"], 0);
              

                double col1 = col2 + col3 + col4 + col5;
                double col6 = col7 + col8;
                double col10 = col11 + col15 + col16 + col17;
                double col23 = col24 + col25;
                double col26 = col27 + col28 + col29;
                ...
                RowItem RowItem7 = new RowItem(7, Utils.AddCommas(col6), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
                ...
                RowItem RowItem11 = new RowItem(11, Utils.AddCommas(col10), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
                ...
                RowItem RowItem24 = new RowItem(24, Utils.AddCommas(col23), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
                ...
                RowItem RowItem30 = new RowItem(30, Utils.AddCommasDouble(dro["Col29Data"].ToString()), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
                RowItem RowItem31 = new RowItem(31, Utils.AddCommasDouble(dro["Col30Data"].ToString()), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
        ...
        public List<TKDonThuInfo> XLD02_GetDSChiTietDonThu(string ContentRootPath, DateTime startDate, DateTime endDate, int start, int pagesize, int? Index, int? xemTaiLieuMat, int? canBoID, int coQuanID, int? capID)
        {
        ...
        public string XLD02_Excel(string rootPath, string pathFile, List<TableData> data, DateTime tuNgay, DateTime denNgay)
        {
            //var camera = new Camera;
            // path to your excel file
            string path = rootPath + @"\Templates\BaoCao\XLD02.xlsx";
        ...
        public void CalculateBaoCaoCapTinh(string ContentRootPath, int RoleID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, ref List<BaoCao2bInfo> resultList, DateTime startDate, DateTime endDate, List<CapInfo> capList, bool flag, int tinhID, ref DataTable dt)
        {
            ...
            if (capList.Count > 0)
            {
                ...
                if (cqList.Count > 0)
                {
                    ...
                    try
                    {
                        using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, "v2_BaoCaoXLD02_New", parm))
                        {
                            dt.Load(dr);
        ...
        public List<TKDonThuInfo> GetDSChiTietDonThu(DateTime startDate, DateTime endDate, List<CoQuanInfo> ListCoQuan, int start, int pagesize, int? Index, int? xemTaiLieuMat, int? canBoID, int? capID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, "v2_BaoCaoXLD02_GetDSChiTietDonThu_New", parm))
                {
                    query.Load(dr);
                }
            }
