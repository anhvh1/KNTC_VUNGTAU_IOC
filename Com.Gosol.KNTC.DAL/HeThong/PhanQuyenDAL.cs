...
namespace Com.Gosol.KNTC.DAL.HeThong
{
    public class PhanQuyenDAL
    {
        ...
        //private DbKNTCContext _DbKNTCContext;
        //public PhanQuyenDAL(DbKNTCContext dbKNTCContext)
        //{
        //    _DbKNTCContext = dbKNTCContext;
        //}
        ...
        public List<NhomNguoiDungModel> NhomNguoiDung_GetAll(BasePagingParamsForFilter p, int? CoQuanID, int NguoiDungID, ref int TotalRow)
        {
            ...
            var storeName = "v2_HeThong_PhanQuyen_NhomNguoidung_GetAll";
                    ...
                    else
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                        {
                            ...
                            using (SqlTransaction trans = conn.BeginTransaction())
                            {
                                try
                                {
                                    Result.Status = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_Insert", parameters);
                                    trans.Commit();
                                }
                                catch (Exception ex)
                                {
        ...
        public NhomNguoiDungModel NhomNguoiDung_GetByCoQuanIDAndNhomTongID(int CoQuanID, int NhomTongID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoidung_GetByCoQuanIDAndNhomTongID", parameters))
                {
                    while (dr.Read())
                    {
                    ...
                    else
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                        {
                            ...
                            using (SqlTransaction trans = conn.BeginTransaction())
                            {
                                try
                                {
                                    var val = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_DeleteByID", parameters);
                                    trans.Commit();
                                }
                                catch
                                {
                        ...
                        else
                        {
                            ...
                            using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                            {
                                ...
                                using (SqlTransaction trans = conn.BeginTransaction())
                                {
                                    try
                                    {
                                        Result.Status = SQLHelper.ExecuteNonQuery(trans, CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_UpdateNhomTong", parameters);
        ...
        public NhomNguoiDungModel NhomNguoiDung_GetByID(int NhomNguoiDungID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_GetByID", parameters))
                {
                    while (dr.Read())
                    {
                        Result.NhomNguoiDungID = Utils.ConvertToInt32(dr["NhomNguoiDungID"], 0);
        ...
        public List<NhomNguoiDungModel> NhomNguoiDung_GetByNhomTongID(int NhomTongID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_GetByNhomTongID", parameters))
                {
                    while (dr.Read())
                    {
        ...
        public List<NhomNguoiDungModel> NhomNguoiDung_GetListNhomCuaDonViCon(int NhomNguoiDungID, int CoQuanID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_GetListNhomCuaDonViCon", parameters))
                {
                    while (dr.Read())
                    {
                        var crObj = new NhomNguoiDungModel();
        ...
        public NhomNguoiDungModel NhomNguoiDung_GetByName(string TenTrangThai)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_GetByName", parameters))
                {
                    while (dr.Read())
                    {
                    ...
                    else
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                        {
                            ...
                            using (SqlTransaction trans = conn.BeginTransaction())
                            {
                                try
                                {
                                    var val = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NhomNguoiDung_Delete", parameters);
                                    trans.Commit();
                                }
                                catch (Exception ex)
                                {
                    ...
                    else
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                        {
                            ...
                            using (SqlTransaction trans = conn.BeginTransaction())
                            {
                                try
                                {
                                    var val = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_NguoiDung_NhomNguoiDung_DeleteByNhomNguoiDungID", parameters);
                                    trans.Commit();
                                }
                                catch (Exception ex)
                                {
                ...
                else
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                    {
                        ...
                        using (SqlTransaction trans = conn.BeginTransaction())
                        {
                            try
                            {
                                Result.Status = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NguoiDung_NhomNguoiDung_Insert", parameters);
                                trans.Commit();
                ...
                else
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                    {
                        ...
                        using (SqlTransaction trans = conn.BeginTransaction())
                        {
                            try
                            {
                                Result.Status = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NguoiDung_NhomNguoiDung_Insert_One", parameters);
                                trans.Commit();
                                Result.Message = ConstantLogMessage.Alert_Insert_Success("Người dùng - Nhóm người dùng");
                            }
                            catch (Exception ex)
        ...
        public NguoiDungNhomNguoiDungModel NguoiDung_NhomNguoiDung_GetByNguoiDungID_And_NhomNguoiDungID(int NguoiDungID, int NhomNguoiDungID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NguoiDung_NhomNguoiDung_GetByNguoiDungID_And_NhomNguoiDungID", parameters))
                {
                    while (dr.Read())
                    {
                        Result.NguoiDungID = Utils.ConvertToInt32(dr["NguoiDungID"], 0);
        ...
        /// <summary>
        /// cập nhật lại nhóm người dùng cho người dùng trong chức năng cập nhật cán bộ
        /// created by anhvh
        /// 13/03/2024
        /// </summary>
        /// <param name="danhSachNhom"></param>
        /// <returns></returns>
        public BaseResultModel NguoiDung_NhomNguoidung_CapNhatNhomNguoiDungChoNguoiDung(List<NguoiDungNhomNguoiDungModel?> danhSachNhom)
        {
            var Result = new BaseResultModel();
            var pList = new SqlParameter("danhSach", SqlDbType.Structured);
            pList.TypeName = "dbo.TwoID";
            var tb = new DataTable();
            tb.Columns.Add("ID1", typeof(int));
            tb.Columns.Add("ID2", typeof(int));
            if (danhSachNhom != null && danhSachNhom.Count > 0)
            {
                danhSachNhom.ForEach(x => tb.Rows.Add(x.NguoiDungID, x.NhomNguoiDungID));
            }
            SqlParameter[] parameters = new SqlParameter[]
            {
                pList
            };
            parameters[0].Value = tb;
            using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
            {
                conn.Open();
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        var val = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_NguoiDung_NhomNguoiDung_CapNhatNhomChoNguoiDung", parameters);
                        trans.Commit();
                    }
                    catch
                    {
            ...
            Result.Status = 1;
            Result.Message = ConstantLogMessage.Alert_Update_Success("Người dùng - Nhóm người dùng");
            return Result;
        }
        ...
        public List<ChucNangModel> ChucNang_GetQuyenByNhomNguoiDungID(int NhomNguoiDungID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_ChucNang_GetQuyenByNhomNguoiDungID", parameters))
                {
                    while (dr.Read())
                    {
                        ChucNangModel item = new ChucNangModel(
                    ...
                    else
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                        {
                            ...
                            using (SqlTransaction trans = conn.BeginTransaction())
                            {
                                try
                                {
                                    var val = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_DeleteByNhomNguoiDungID", parameters);
                                    trans.Commit();
                                }
                                catch
                                {
                    ...
                    if (checkPhanQuyen == null || checkPhanQuyen.ChucNangID < 1)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                        {
                            ...
                            using (SqlTransaction trans = conn.BeginTransaction())
                            {
                                try
                                {
                                    Result.Status = SQLHelper.ExecuteNonQuery(trans, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_Insert", parameters);
                                    trans.Commit();
        ...
        public List<NhomNguoiDungModel> NhomNguoiDung_GetByCoQuanSuDungPM_NhomCanChinhSua(int CoQuanDangNhap, int NhomNguoiDungID)
        {
            List<NhomNguoiDungModel> Result = new List<NhomNguoiDungModel>();
            var tbCoQuanID = new DataTable();
            tbCoQuanID.Columns.Add("CoQuanID", typeof(string));
            var DanhSachCoQuanCon = new DanhMucCoQuanDonViDAL().GetAllCoQuanConDaCap(CoQuanDangNhap);
            DanhSachCoQuanCon.ForEach(x => tbCoQuanID.Rows.Add(x.CoQuanID));
            SqlParameter[] parameters = new SqlParameter[]
              {
                new SqlParameter(@"DanhSachCoQuanID",SqlDbType.Structured),
                new SqlParameter(@"NhomNguoiDungID",SqlDbType.Int)
              };
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v1_HeThong_PhanQuyen_NhomNguoiDung_GetByCoQuanSuDungPM", parameters))
                {
                    while (dr.Read())
                    {
                        var crObj = new NhomNguoiDungModel();
        ...
        public BaseResultModel PhanQuyen_InsertMulti(List<PhanQuyenModel> PhanQuyenModel, int? CoQuanID, int? NguoiDungID)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        var isPhanQuyen = PhanQuyen_Insert(PhanQuyenModel[i], CoQuanID, NguoiDungID);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                        {
                            ...
                            var listNhomNguoiDungCon = new List<NhomNguoiDungModel>();
                            if (UserRole.CheckAdmin(NguoiDungID.Value))
                            {
                                listNhomNguoiDungCon = NhomNguoiDung_GetByNhomTongID(crObj.NhomNguoiDungID);
                            }
                            else
                            {
                                listNhomNguoiDungCon = NhomNguoiDung_GetByCoQuanSuDungPM_NhomCanChinhSua(CoQuanID is null ? 0 : CoQuanID.Value, crObj.NhomNguoiDungID);
                            }
                            if (listNhomNguoiDungCon != null && listNhomNguoiDungCon.Count > 0)
                            {
                                for (int i = 0; i < listNhomNguoiDungCon.Count; i++)
        ...
        public BaseResultModel PhanQuyen_Update(PhanQuyenModel PhanQuyenModel, int? CoQuanID, int? NguoiDungID)
        {
            var Result = new BaseResultModel();
            try
            {
                ...
                else
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(SQLHelper.appConnectionStrings))
                    {
                        ...
                        using (SqlTransaction trans = conn.BeginTransaction())
                        {
                            ...
                            //Edit by ChungNN 8/6/2021
                            var listNhomNguoiDungCon = new List<NhomNguoiDungModel>();
                            if (UserRole.CheckAdmin(NguoiDungID.Value))
                            {
                                listNhomNguoiDungCon = NhomNguoiDung_GetByNhomTongID(PhanQuyenModel.NhomNguoiDungID);
                            }
                            else
                            {
                                listNhomNguoiDungCon = NhomNguoiDung_GetByCoQuanSuDungPM_NhomCanChinhSua(CoQuanID is null ? 0 : CoQuanID.Value, PhanQuyenModel.NhomNguoiDungID);
                            }
                            //////////////////////////////////////////////////////////
        ...
        public BaseResultModel PhanQuyen_UpdateMulti(List<PhanQuyenModel> PhanQuyenModel, int? CoQuanID, int? NguoiDungID)
        {
            ...
            try
            {
                ...
                else
                {
                    for (int i = 0; i < PhanQuyenModel.Count; i++)
                    {
                        var isPhanQuyen = PhanQuyen_Update(PhanQuyenModel[i], CoQuanID, NguoiDungID);
                        if (isPhanQuyen.Status < 1)
                        {
                            return isPhanQuyen;
                        }
        ...
        public ChucNangModel PhanQuyen_GetByNhomNguoiDungID_And_ChucNangID(int NhomNguoiDungID, int ChucNangID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_GetByNhomNguoiDungID_And_ChucNangID", parameters))
                {
                    while (dr.Read())
                    {
        ...
        public List<HeThongCanBoModel> HeThongCanBo_GetAllByListCoQuanID(int NhomNguoiDungID, int CoQuanID, int NguoiDungID)
        {
            ...
            try
            {
                ...
                //if (UserRole.CheckAdmin(NguoiDungID))
                //{
                //    ListCoQuan = new DanhMuKNTCoQuanDonViDAL().GetAllCapCon(0).Where(x => x.CoQuanID != CoQuanID).ToList();

                //}
                //else ListCoQuan = new DanhMuKNTCoQuanDonViDAL().GetAllCapCon(CoQuanID);
        ...
        //                {
        //                    NhomNguoiDungModel.DanhSachCoQuanID = new List<int>();
        //                    var listCoQuan = new List<DanhMuKNTCoQuanDonViModel>();
        //                    // nếu là Admin hệ thống thì tạo cho toàn bộ hệ thống
        //                    if (UserRole.CheckAdmin(NguoiDungID))
        //                    {
        //                        listCoQuan = new DanhMuKNTCoQuanDonViDAL().GetAllIDByCoQuanChaID(0).Where(x => x.CoQuanID != CoQuanID).ToList();
        //                    }
        //                    // nếu ko thì tạo cho toàn bộ đơn vị trực thuộc đơn vị
        //                    else
        //                    {
        //                        listCoQuan = new DanhMuKNTCoQuanDonViDAL().GetAllIDByCoQuanChaID(CoQuanID);
        //                    }
        //                    if (listCoQuan.Count > 0)
        //                    {
        //                        listCoQuan.ForEach(x => NhomNguoiDungModel.DanhSachCoQuanID.Add(x.CoQuanID));
        ...
        //                        }
        //                    }
        //                    Result.Message = ConstantLogMessage.Alert_Insert_SuKNTCess("Nhóm người dùng");
        //                }
        //            }
        //        }
        //    }
        ...
        public List<HeThongNguoiDungModel> HeThong_NguoiDung_GetListBy_NhomNguoiDungID(int NhomNguoiDungID, int NguoiDungID)
        {
            ...
            try
            {
                ...
                if (listDonViCoTrongNhomNguoiDung.Count != listDonViTrucThuoc.Count)
                {
                    if (listDonViCoTrongNhomNguoiDung.Count > 0)
                    {
                        DanhSachCoQuanID.AddRange(listDonViCoTrongNhomNguoiDung.Select(x => x.CoQuanID).ToList());
                    }
                }
                else
                {
                    ...
                    {
                        DanhSachCoQuanID.AddRange(listDonViTrucThuoc.Select(x => x.CoQuanID).ToList());
                    }
                }
        ...
        public List<NguoiDungNhomNguoiDungModel> NguoiDung_NhomNguoiDung_GetByListNhomNguoiDungID(List<int> DanhSachNhomNguoiDungID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v2_HeThong_PhanQuyen_NguoiDung_NhomNguoiDung_GetBy_ListNhomNguoiDungID", parameters))
                {
                    while (dr.Read())
                    {
                        ...
                        crObj.NhomNguoiDungID = Utils.ConvertToInt32(dr["NhomNguoiDungID"], 0);
                        crObj.NguoiDungID = Utils.ConvertToInt32(dr["NguoiDungID"], 0);
                        crObj.TenNguoiDung = Utils.ConvertToString(dr["TenNguoiDung"], string.Empty) + " (" + Utils.ConvertToString(dr["TenCanBo"], string.Empty) + " - " + Utils.ConvertToString(dr["TenCoQuan"], string.Empty) + ")";
                        Result.Add(crObj);
                    }
                    dr.Close();
                }
        ...
        public List<int> GetNhomNguoiDungByNguoiDungID(int NguoiDungID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, System.Data.CommandType.StoredProcedure, "v1_HeThong_PhanQuyen_GetNhomNguoiDungByNguoiDungID", parameters))
                {
                    while (dr.Read())
                    {
                        int NhomNguoiDungID = Utils.ConvertToInt32(dr["NhomNguoiDungID"], 0);
                        Result.Add(NhomNguoiDungID);
                    }
                    dr.Close();
                }
            }
