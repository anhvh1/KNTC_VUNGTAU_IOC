...
namespace Com.Gosol.KNTC.DAL.KNTC
{
    public class DoiTuongKNDAL
    {
        ...
        private DoiTuongKNInfo GetCustomDataByNhomKNID(SqlDataReader dr)
        {
            ...
            info.CMND = Utils.GetString(dr["CMND"], string.Empty);
            info.HoTen = Utils.GetString(dr["HoTen"], string.Empty);
            info.GioiTinh = Utils.ConvertToNullableInt32(dr["GioiTinh"], null);
            info.DiaChiCT = Utils.GetString(dr["DiaChiCT"], string.Empty);
            info.SoNha = Utils.GetString(dr["SoNha"], string.Empty);
            info.NhomKNID = Utils.GetInt32(dr["NhomKNID"], 0);
            ...
            info.QuocTichID = Utils.ConvertToNullableInt32(dr["QuocTichID"], null);
            info.DanTocID = Utils.ConvertToNullableInt32(dr["DanTocID"], null);
            return info;
        }
        //Get Insert Parmas
        private SqlParameter[] GetInsertParms()
        {
            SqlParameter[] parms = new SqlParameter[]{
                ...
                new SqlParameter(PARAM_NGHENGHIEP, SqlDbType.NVarChar, 200),
                ...
                new SqlParameter(PARAM_SODIENTHOAI, SqlDbType.NVarChar,20),
                new SqlParameter(PARAM_NGAYCAP, SqlDbType.DateTime),
                new SqlParameter(PARAM_NOICAP, SqlDbType.NVarChar, 200)
                };
            return parms;
        }
        ...
        private void SetInsertParms(SqlParameter[] parms, DoiTuongKNInfo info)
        {
            ...
            parms[0].Value = info.HoTen;
            parms[1].Value = info.CMND;
            parms[2].Value = info.GioiTinh;
            parms[3].Value = info.NgheNghiep;
            parms[4].Value = info.QuocTichID;
            parms[5].Value = info.DanTocID;
            parms[6].Value = info.TinhID;
            parms[7].Value = info.HuyenID;
            parms[8].Value = info.XaID;
            parms[9].Value = info.DiaChiCT;
            parms[10].Value = info.NhomKNID;
            parms[11].Value = info.SoDienThoai;
            parms[12].Value = info.NgayCap;
            parms[13].Value = info.NoiCap;
        ...
        private void SetUpdateParms(SqlParameter[] parms, DoiTuongKNInfo info)
        {
            ...
            parms[1].Value = info.HoTen;
            parms[2].Value = info.CMND;
            parms[3].Value = info.GioiTinh;
            parms[4].Value = info.NgheNghiep;
            parms[5].Value = info.QuocTichID;
            parms[6].Value = info.DanTocID;
            parms[7].Value = info.TinhID;
            parms[8].Value = info.HuyenID;
            parms[9].Value = info.XaID;
            parms[10].Value = info.DiaChiCT;
            parms[11].Value = info.NhomKNID;
            parms[12].Value = info.SoDienThoai;
            parms[13].Value = info.NgayCap;
            parms[14].Value = info.NoiCap;
            if (info.NgayCap == null)
            {
                parms[13].Value = DBNull.Value;
            }
