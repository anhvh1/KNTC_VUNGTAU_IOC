...
{
    public class XLD01_TT2024DAL
    {
        public List<TableData> XLD01_TT2024(List<int> listCapChonBaoCao, string ContentRootPath, int RoleID, int CapID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, int HuyenDangNhapID, DateTime startDate, DateTime endDate)
        {
            ...
            foreach (DataRow dro in dt.Rows)
            {
                ...
                double col6 = col8 + col9 + col10;
                double col14 = col15 + col16 + col17;
                ...
                RowItem RowItem15 = new RowItem(15, Utils.AddCommas(col14), dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
                ...
                RowItem RowItem23 = new RowItem(23, "", dro["CoQuanID"].ToString(), dro["CapID"].ToString(), null, "text-align: center;" + Css, ref DataArr);
        ...
        public List<TKDonThuInfo> XLD01_TT2024_GetDSChiTietDonThu(string ContentRootPath, DateTime startDate, DateTime endDate, int start, int pagesize, int? Index, int? xemTaiLieuMat, int? canBoID, int coQuanID, int? capID)
        {
        ...
        public string XLD01_TT2024_Excel(string rootPath, string pathFile, List<TableData> data, DateTime tuNgay, DateTime denNgay)
        {
            //var camera = new Camera;
            // path to your excel file
            string path = rootPath + @"\Templates\BaoCao_TT2024\XLD01_TT2024.xlsx";
        ...
        public void CalculateBaoCaoCapTinh(string ContentRootPath, int RoleID, int CoQuanDangNhapID, int CanBoDangNhapID, int TinhDangNhapID, ref List<BaoCao2bInfo> resultList, DateTime startDate, DateTime endDate, List<CapInfo> capList, bool flag, int tinhID, ref DataTable dt)
        {
            ...
            if (capList.Count > 0)
            {
                ...
                if (cqList.Count > 0)
                {
                    ...
                    try
                    {
                        using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, "v2_BaoCaoXLD01_New_TT2024", parm))
                        {
                            dt.Load(dr);
                        }
                    }
        ...
        public List<TKDonThuInfo> GetDSChiTietDonThu(DateTime startDate, DateTime endDate, List<CoQuanInfo> ListCoQuan, int start, int pagesize, int? Index, int? xemTaiLieuMat, int? canBoID, int? capID)
        {
            ...
            try
            {
                using (SqlDataReader dr = SQLHelper.ExecuteReader(SQLHelper.appConnectionStrings, CommandType.StoredProcedure, "BaoCaoXLD01_GetDSChiTietDonThu_TT2024", parm))
                {
                    query.Load(dr);
                }
            }
        ...
        #region 2b
        private const string GET_DONTHU = "BaoCao2b_GetDonThu_TT2024";
        //private const string GET_DONTHU = "BaoCao2b_GetDonThu";
        //private const string GET_DONTHU_BY_TINH = "BaoCao2b_GetDonThuByTinh";
        private const string GET_DONTHU_BY_TINH = "BaoCao2b_GetDonThuByTinh_TT2024";
        ...
        private const string INSERT = @"BaoCao2b_Insert_TT2024";
        //private const string UPDATE = @"BaoCao2b_Update";       
        private const string UPDATE = @"BaoCao2b_Update_TT2024";
        //private const string GET_ALL_XA_BY_COQUANHUYEN = @"BaoCao2b_GetAllCapXaByHuyen";
        private const string GET_ALL_XA_BY_COQUANHUYEN = @"BaoCao2b_GetAllCapXaByHuyen_TT2024";
