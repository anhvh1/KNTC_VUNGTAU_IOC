namespace Com.Gosol.KNTC.Security
{
    ...
    {
        private string DELETE_AKNTCESSRIGHT_ACL = "Delete ObjectACL Where ObjectTypeid = @ObjectTypeid And Objectid = @Objectid And Entityid = @Entityid";
        private string DELETE_AKNTCESSRIGHT_ACLTYPE = "Delete ObjectTypeACL Where ObjectTypeid = @ObjectTypeid And Entityid = @Entityid";
        private string DELETE_USER_GROUP = "Delete UserGroup Where Userid = @Userid And Groupid = @Groupid";
        private string INSERT_AKNTCESSRIGHT_ACL = "Insert Into ObjectACL (ObjectTypeid, Objectid, Entityid, EntityType, AKNTCessRight) Values(@ObjectTypeid, @Objectid, @Entityid, 1, @AKNTCessRight)";
        private string INSERT_AKNTCESSRIGHT_ACLTYPE = "Insert Into ObjectTypeACL (ObjectTypeid, Entityid, EntityType, AKNTCessRight) Values(@ObjectTypeid, @Entityid, 1, @AKNTCessRight)";
        private string INSERT_USER_GROUP = "Insert Into UserGroup (Userid, Groupid) Values(@Userid, @Groupid)";
        private string PARM_AKNTCESSRIGHT = "@AKNTCessRight";
        ...
        private string SELECT_AKNTCESSRIGHT_ACL = "Select AKNTCessRight From ObjectACL Where ObjectTypeid = @ObjectTypeid And Objectid = @Objectid And Entityid = @Entityid";
        private string SELECT_AKNTCESSRIGHT_ACLTYPE = "Select AKNTCessRight From ObjectTypeACL Where ObjectTypeid = @ObjectTypeid And Entityid = @Entityid";
        ...
        private string UPDATE_AKNTCESSRIGHT_ACL = "Update ObjectACL Set AKNTCessRight = @AKNTCessRight Where ObjectTypeid = @ObjectTypeid And Objectid = @Objectid And Entityid = @Entityid";
        private string UPDATE_AKNTCESSRIGHT_ACLTYPE = "Update ObjectTypeACL Set AKNTCessRight = @AKNTCessRight Where ObjectTypeid = @ObjectTypeid And Entityid = @Entityid";
        ...
        public bool DeleteACL(int objectTypeid, int objectid, int entityid)
        {
            ...
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.DELETE_AKNTCESSRIGHT_ACL);
        ...
        {
            IDbConnection dbConnection = DatabaseProxy.CreateDBConnection();
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.DELETE_AKNTCESSRIGHT_ACLTYPE);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_ENTITY_id, entityid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECTTYPE_id, objectTypeid);
            return this.ExecuteNonQuery(dbConnection, dbCommand);
        }
        ...
        public AccessLevel GetAKNTCessRight(int objectTypeid, int entityid)
        {
            object noAKNTCess;
            IDbConnection dbConnection = DatabaseProxy.CreateDBConnection();
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.SELECT_AKNTCESSRIGHT_ACLTYPE);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECTTYPE_id, objectTypeid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_ENTITY_id, entityid);
            try
            {
                dbConnection.Open();
                noAKNTCess = dbCommand.ExecuteScalar();
            }
            catch (Exception exception)
            {
                throw new DatabaseProxyException("Error at GetAKNTCessRight method in SecurityProxy class. Detail:" + exception.Message);
            }
            finally
            {
                dbConnection.Close();
            ...
            if (noAKNTCess == null)
            {
                noAKNTCess = AccessLevel.NoAKNTCess;
            }
            return (AccessLevel) noAKNTCess;
        }

        public AccessLevel GetAKNTCessRight(int objectTypeid, int objectid, int entityid)
        {
            object noAKNTCess;
            IDbConnection dbConnection = DatabaseProxy.CreateDBConnection();
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.SELECT_AKNTCESSRIGHT_ACL);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECTTYPE_id, objectTypeid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECT_id, objectid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_ENTITY_id, entityid);
            try
        ...
        public bool InsertACL(int objectTypeid, int objectid, int entityid, int aKNTCess)
        {
            IDbConnection dbConnection = DatabaseProxy.CreateDBConnection();
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.INSERT_AKNTCESSRIGHT_ACL);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_AKNTCESSRIGHT, aKNTCess);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_ENTITY_id, entityid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECTTYPE_id, objectTypeid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECT_id, objectid);
            return this.ExecuteNonQuery(dbConnection, dbCommand);
        ...
        public bool InsertACLType(int objectTypeid, int entityid, int aKNTCess)
        {
            IDbConnection dbConnection = DatabaseProxy.CreateDBConnection();
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.INSERT_AKNTCESSRIGHT_ACLTYPE);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_AKNTCESSRIGHT, aKNTCess);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_ENTITY_id, entityid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECTTYPE_id, objectTypeid);
            return this.ExecuteNonQuery(dbConnection, dbCommand);
        ...
        public bool UpdateACL(int objectTypeid, int objectid, int entityid, int aKNTCess)
        {
            IDbConnection dbConnection = DatabaseProxy.CreateDBConnection();
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.UPDATE_AKNTCESSRIGHT_ACL);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_AKNTCESSRIGHT, aKNTCess);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_ENTITY_id, entityid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECTTYPE_id, objectTypeid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECT_id, objectid);
        ...
        public bool UpdateACLType(int objectTypeid, int entityid, int aKNTCess)
        {
            IDbConnection dbConnection = DatabaseProxy.CreateDBConnection();
            IDbCommand dbCommand = DatabaseProxy.CreateDBCommand(dbConnection, this.UPDATE_AKNTCESSRIGHT_ACLTYPE);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_AKNTCESSRIGHT, aKNTCess);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_ENTITY_id, entityid);
            DatabaseProxy.AddParameter(dbCommand, this.PARM_OBJECTTYPE_id, objectTypeid);
            return this.ExecuteNonQuery(dbConnection, dbCommand);
