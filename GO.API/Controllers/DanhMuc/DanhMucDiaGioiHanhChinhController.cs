...
namespace Com.Gosol.CC.API.Controllers.DanhMuc
{

    [Route("api/v2/DanhMucDiaGioiHanhChinh")]
    [ApiController]
    public class DanhMucDiaGioiHanhChinhController : BaseApiController
    {
        private DanhMucDiaGioiHanhChinhBUS _DanhMucDiaGioiHanhChinhBUS;

        public DanhMucDiaGioiHanhChinhController(ILogHelper _LogHelper, ILogger<DanhMucDiaGioiHanhChinhController> logger) : base(_LogHelper, logger)
        {

            this._DanhMucDiaGioiHanhChinhBUS = new DanhMucDiaGioiHanhChinhBUS();
        ...
        public IActionResult GetListByidAndCap()
        {
            try
            {
                return CreateActionResult(false, ConstantLogMessage.DanhMuc_DiaGioiHanhChinh_GetListByidAndCap, EnumLogType.GetList, () =>
                 {
        ...
        public IActionResult FilterByName(string FilterName)
        {
            try
            {
                return CreateActionResult(false, ConstantLogMessage.DanhMuc_DiaGioiHanhChinh_FilterByName, EnumLogType.GetList, () =>
                 {
                     var NguoiDungID = Utils.ConvertToInt32(User.Claims.FirstOrDefault(c => c.Type == "NguoiDungID").Value, 0);
                     IList<DanhMucDiaGioiHanhChinhModel> Data;
        ...
        public IActionResult GetByIDAnfCap([FromQuery] int id, int Cap, string Keyword)
        {
            try
            {
                return CreateActionResult(false, ConstantLogMessage.DanhMuc_DiaGioiHanhChinh_GetByID, EnumLogType.GetList, () =>
                {
                    var NguoiDungID = Utils.ConvertToInt32(User.Claims.FirstOrDefault(c => c.Type == "NguoiDungID").Value, 0);
